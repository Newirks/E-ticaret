...
?>
  ...
  <div class="container-fluid odeme_adres">
  	...
  	<div class="container">
  		<form action="payment_add_2.php" method="post" id="adres" name="adres">
  		<div class="row">
  			...
  			<div class="col-md-9">
  				...
  				<div class="kayitli_adres">
  					...
  					<?php
  						...
  						$adres_sorgula = mysqli_query($conn,"SELECT * FROM uyeler_fatura_defter WHERE uye_id = '$uyeid'");
  					...
  					}else { echo "<p><i>Henüz kayıtlı Fatura adresiniz bulunmamaktadır.</i></p>"; }
  					...
  					<p><i>Fatura için adres giriniz.</i></p>
            ...
            <input  type="email" name="email" class="email" placeholder="*Email" required="required">
  				...
  				<div class="yeni_adres">
  					...
  					<div class="yeni_adres_baslik">Fatura Adresi Ekle</div>
